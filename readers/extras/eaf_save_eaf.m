function status = eaf_save_eaf(Fname, Ann, Vars)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function status = eaf_save_eaf_writer(fid, Ann, Vars)
